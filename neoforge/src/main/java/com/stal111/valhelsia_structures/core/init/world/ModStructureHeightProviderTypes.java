...
public class ModStructureHeightProviderTypes implements RegistryClass {
    ...
    private static <P extends StructureHeightProvider> RegistryEntry<StructureHeightProviderType<?>, StructureHeightProviderType<P>> register(String name, MapCodec<P> codec) {
