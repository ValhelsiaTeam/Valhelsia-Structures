...
public class BelowSurfaceHeightProvider extends StructureHeightProvider {
    ...
    public int maxY(BlockPos pos, Structure.GenerationContext context, Heightmap.Types heightmapType) {
        return Math.max(this.minY(pos, context, heightmapType), context.chunkGenerator().getFirstOccupiedHeight(pos.getX(), pos.getZ(), heightmapType, context.heightAccessor(), context.randomState()) - 12);
    }
