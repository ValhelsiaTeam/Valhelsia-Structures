...
public class ForgeStructure extends ScatteredStructure<NoFeatureConfig> {
    ...
    public static final String NAME = ValhelsiaStructures.MOD_ID +  ":Forge";
    ...
    public static class Start extends MarginedStructureStart {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
            ...
            if (maxHeight - minHeight < 2 && maxHeight - minHeight > -2) {
                ...
                ForgePieces.func_215139_a(generator, templateManagerIn, blockpos, this.components, this.rand);
