...
public class ModStructureProcessors implements RegistryClass {
    ...
    public static final MappedRegistryHelper<StructureProcessorType<?>> HELPER = ValhelsiaStructures.REGISTRY_MANAGER.getMappedHelper(Registries.STRUCTURE_PROCESSOR);
