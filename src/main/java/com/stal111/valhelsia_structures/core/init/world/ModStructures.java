...
public class ModStructures implements RegistryClass {
    ...
    public static final Holder<? extends Structure> WITCH_HUT = register("witch_hut",
            () -> new ValhelsiaJigsawStructure(structure(ModTags.Biomes.HAS_WITCH_HUT, TerrainAdjustment.BEARD_THIN), "witch_hut", SimpleStructurePools.WITCH_HUT_PATTERN, 7, StructureHeightProvider.constant(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG, false),
