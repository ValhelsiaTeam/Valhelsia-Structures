...
public class ModStructures implements RegistryClass {
    ...
    public static final Holder<? extends Structure> CASTLE = register("castle",
            () -> new ValhelsiaJigsawStructure(structure(ModTags.Biomes.HAS_CASTLE, TerrainAdjustment.BEARD_THIN), "castle", SimpleStructurePools.CASTLE_PATTERN, 7, ConstantHeight.of(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG),
    ...
    public static final Holder<? extends Structure> CASTLE_RUIN = register("castle_ruin",
            () -> new ValhelsiaJigsawStructure(structure(ModTags.Biomes.HAS_CASTLE_RUIN, TerrainAdjustment.BEARD_THIN), "castle_ruin", SimpleStructurePools.CASTLE_RUIN_PATTERN, 7, ConstantHeight.of(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG),
    ...
    public static final Holder<? extends Structure> DESERT_HOUSE = register("desert_house",
            () -> new ValhelsiaJigsawStructure(structure(ModTags.Biomes.HAS_DESERT_HOUSE, TerrainAdjustment.BEARD_THIN), "desert_house", DesertHousePools.PATTERN, 7, ConstantHeight.of(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG),
    ...
    public static final Holder<? extends Structure> FORGE = register("forge",
            () -> new ValhelsiaJigsawStructure(structure(ModTags.Biomes.HAS_FORGE, TerrainAdjustment.BEARD_THIN), "forge", SimpleStructurePools.FORGE_PATTERN, 7, ConstantHeight.of(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG),
            ValhelsiaStructureSettings.of(ConfigurableValue.of(0.7D), ConfigurableValue.of(20)));
    public static final Holder<? extends Structure> PLAYER_HOUSE = register("player_house",
            () -> new ValhelsiaJigsawStructure(structure(ModTags.Biomes.HAS_PLAYER_HOUSE, TerrainAdjustment.BEARD_THIN), "player_house", PlayerHousePools.PATTERN, 7, ConstantHeight.of(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG),
    ...
    public static final Holder<? extends Structure> SPAWNER_DUNGEON = register("spawner_dungeon",
            () -> new ValhelsiaJigsawStructure(structure(ModTags.Biomes.HAS_SPAWNER_DUNGEON, GenerationStep.Decoration.UNDERGROUND_STRUCTURES, TerrainAdjustment.BEARD_THIN), "spawner_dungeon", SpawnerDungeonPools.PATTERN, 7, ConstantHeight.of(VerticalAnchor.absolute(10))),
    ...
    public static final Holder<? extends Structure> TOWER_RUIN = register("tower_ruin",
            () -> new ValhelsiaJigsawStructure(structure(ModTags.Biomes.HAS_TOWER_RUIN, TerrainAdjustment.BEARD_THIN), "tower_ruin", SimpleStructurePools.TOWER_RUIN_PATTERN, 7, ConstantHeight.of(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG),
    ...
    public static final Holder<? extends Structure> WITCH_HUT = register("witch_hut",
            () -> new ValhelsiaJigsawStructure(structure(ModTags.Biomes.HAS_WITCH_HUT, TerrainAdjustment.BEARD_THIN), "witch_hut", SimpleStructurePools.WITCH_HUT_PATTERN, 7, ConstantHeight.of(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG),
    ...
    public static final Holder<? extends Structure> BIG_TREE = register("big_tree",
            () -> new ValhelsiaJigsawStructure(structure(ModTags.Biomes.HAS_BIG_TREE, TerrainAdjustment.BEARD_THIN), "big_tree", BigTreePools.PATTERN, 7, ConstantHeight.of(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG),
