...
public class ModStructures implements RegistryClass {
    ...
    public static final RegistryHelper<Structure> HELPER = ValhelsiaStructures.REGISTRY_MANAGER.getHelper(Registries.STRUCTURE);
    ...
    public static void bootstrap(BootstapContext<Structure> context) {
        ...
        context.register(FORGE, new LegacyValhelsiaJigsawStructure(structure(biomeRegistry.getOrThrow(ModTags.Biomes.HAS_FORGE), TerrainAdjustment.BEARD_THIN), "forge", LegacySimpleStructurePools.FORGE_PATTERN, 7, StructureHeightProvider.constant(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG, ModStructureSets.CASTLE_RUINS, ModStructureSets.CASTLES, ModStructureSets.PLAYER_HOUSES, ModStructureSets.TOWER_RUINS, ModStructureSets.BIG_TREES));
        ...
        context.register(BIG_TREE, new LegacyValhelsiaJigsawStructure(structure(biomeRegistry.getOrThrow(ModTags.Biomes.HAS_BIG_TREE), TerrainAdjustment.BEARD_THIN), "big_tree", BigTreePools.PATTERN, 7, StructureHeightProvider.constant(VerticalAnchor.absolute(0)), Heightmap.Types.WORLD_SURFACE_WG, ModStructureSets.CASTLE_RUINS, ModStructureSets.FORGES, ModStructureSets.PLAYER_HOUSES, ModStructureSets.TOWER_RUINS, ModStructureSets.CASTLES));
        context.register(SPAWNER_ROOM, new ValhelsiaJigsawStructure(structure(biomeRegistry.getOrThrow(ModTags.Biomes.HAS_SPAWNER_ROOM), GenerationStep.Decoration.UNDERGROUND_STRUCTURES, TerrainAdjustment.NONE), "spawner_room", templatePoolRegistry.getOrThrow(SimpleStructurePools.SPAWNER_ROOM), 7, StructureHeightProvider.spawnerRoom(VerticalAnchor.absolute(0)), false));
        context.register(DEEP_SPAWNER_ROOM, new ValhelsiaJigsawStructure(structure(biomeRegistry.getOrThrow(ModTags.Biomes.HAS_DEEP_SPAWNER_ROOM), GenerationStep.Decoration.UNDERGROUND_STRUCTURES, TerrainAdjustment.NONE), "deep_spawner_room", templatePoolRegistry.getOrThrow(SimpleStructurePools.DEEP_SPAWNER_ROOM), 7, StructureHeightProvider.deepSpawnerRoom(VerticalAnchor.aboveBottom(6), VerticalAnchor.absolute(-1)), false));
    }
