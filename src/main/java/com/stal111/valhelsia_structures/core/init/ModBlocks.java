...
public class ModBlocks implements RegistryClass {
    ...
    public static final RegistryObject<SpecialSpawnerBlock> SPECIAL_SPAWNER = HELPER.register("special_spawner", () -> new SpecialSpawnerBlock(Block.Properties.copy(Blocks.SPAWNER).strength(-1.0F, 3600000.0F).noLootTable()));
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<BrazierBlock> BRAZIER = HELPER.register("brazier", () -> new BrazierBlock(true, 1, Block.Properties.copy(Blocks.IRON_BARS).noOcclusion().lightLevel(state -> state.getValue(BrazierBlock.LIT) ? 15 : 0)));
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<BrazierBlock> SOUL_BRAZIER = HELPER.register("soul_brazier", () -> new BrazierBlock(false, 2, Block.Properties.copy(Blocks.IRON_BARS).noOcclusion().lightLevel(state -> state.getValue(BrazierBlock.LIT) ? 11 : 0)));
    ...
    public static final RegistryObject<CutPostBlock> CUT_STRIPPED_OAK_POST = HELPER.register("cut_stripped_oak_post", () -> new CutPostBlock(BlockProperties.createCutPostBlock(MaterialColor.WOOD, MaterialColor.PODZOL)));
    public static final RegistryObject<CutPostBlock> CUT_STRIPPED_SPRUCE_POST = HELPER.register("cut_stripped_spruce_post", () -> new CutPostBlock(BlockProperties.createCutPostBlock(MaterialColor.PODZOL, MaterialColor.COLOR_BROWN)));
    public static final RegistryObject<CutPostBlock> CUT_STRIPPED_BIRCH_POST = HELPER.register("cut_stripped_birch_post", () -> new CutPostBlock(BlockProperties.createCutPostBlock(MaterialColor.SAND, MaterialColor.QUARTZ)));
    public static final RegistryObject<CutPostBlock> CUT_STRIPPED_JUNGLE_POST = HELPER.register("cut_stripped_jungle_post", () -> new CutPostBlock(BlockProperties.createCutPostBlock(MaterialColor.DIRT, MaterialColor.PODZOL)));
    public static final RegistryObject<CutPostBlock> CUT_STRIPPED_ACACIA_POST = HELPER.register("cut_stripped_acacia_post", () -> new CutPostBlock(BlockProperties.createCutPostBlock(MaterialColor.COLOR_ORANGE, MaterialColor.STONE)));
    public static final RegistryObject<CutPostBlock> CUT_STRIPPED_DARK_OAK_POST = HELPER.register("cut_stripped_dark_oak_post", () -> new CutPostBlock(BlockProperties.createCutPostBlock(MaterialColor.COLOR_BROWN, MaterialColor.COLOR_BROWN)));
    public static final RegistryObject<CutPostBlock> CUT_STRIPPED_WARPED_POST = HELPER.register("cut_stripped_warped_post", () -> new CutPostBlock(BlockProperties.createCutNetherPostBlock(MaterialColor.WARPED_STEM)));
    public static final RegistryObject<CutPostBlock> CUT_STRIPPED_CRIMSON_POST = HELPER.register("cut_stripped_crimson_post", () -> new CutPostBlock(BlockProperties.createCutNetherPostBlock(MaterialColor.CRIMSON_STEM)));
    public static final RegistryObject<CutPostBlock> CUT_STRIPPED_LAPIDIFIED_JUNGLE_POST = HELPER.register("cut_stripped_lapidified_jungle_post", () -> new CutPostBlock(BlockProperties.LAPIDIFIED_JUNGLE_LOG.noOcclusion()));
    ...
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<HangingVinesBlock> HANGING_VINES = HELPER.register("hanging_vines", () -> new HangingVinesBlock(Block.Properties.of(Material.REPLACEABLE_PLANT).randomTicks().noCollission().strength(0.2F).sound(SoundType.VINE)));
    ...
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<DousedTorchBlock> DOUSED_TORCH = HELPER.registerNoItem("doused_torch", () -> new DousedTorchBlock((TorchBlock) Blocks.TORCH, Block.Properties.of(Material.DECORATION).noCollission().instabreak()));
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<DousedWallTorchBlock> DOUSED_WALL_TORCH = HELPER.registerNoItem("doused_wall_torch", () -> new DousedWallTorchBlock((TorchBlock) Blocks.WALL_TORCH, Block.Properties.of(Material.DECORATION).noCollission().instabreak()));
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<DousedTorchBlock> DOUSED_SOUL_TORCH = HELPER.registerNoItem("doused_soul_torch", () -> new DousedTorchBlock((TorchBlock) Blocks.SOUL_TORCH, Block.Properties.of(Material.DECORATION).noCollission().instabreak()));
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<DousedWallTorchBlock> DOUSED_SOUL_WALL_TORCH = HELPER.registerNoItem("doused_soul_wall_torch", () -> new DousedWallTorchBlock((TorchBlock) Blocks.SOUL_WALL_TORCH, Block.Properties.of(Material.DECORATION).noCollission().instabreak()));
    ...
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<BonePileBlock> BONE_PILE = HELPER.register("bone_pile", () -> new BonePileBlock(Block.Properties.copy(Blocks.BONE_BLOCK).noOcclusion()));
    ...
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<UnlitLanternBlock> UNLIT_LANTERN = HELPER.register("unlit_lantern", () -> new UnlitLanternBlock(() -> Blocks.LANTERN, Block.Properties.copy(Blocks.LANTERN).lightLevel(value -> 0)));
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<UnlitLanternBlock> UNLIT_SOUL_LANTERN = HELPER.register("unlit_soul_lantern", () -> new UnlitLanternBlock(() -> Blocks.SOUL_LANTERN, Block.Properties.copy(Blocks.SOUL_LANTERN).lightLevel(value -> 0)));
    ...
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<Block> GRASS_BLOCK = HELPER.register("grass_block", () -> new ValhelsiaGrassBlock(Block.Properties.copy(Blocks.GRASS_BLOCK).lootFrom(() -> Blocks.GRASS_BLOCK)));
