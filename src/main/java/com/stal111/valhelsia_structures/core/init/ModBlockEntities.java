...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<ExplorersTentBlockEntity>> TENT = register("explorers_tent", () -> BlockEntityType.Builder.of(ExplorersTentBlockEntity::new).build(null));
    public static final RegistryObject<BlockEntityType<GiantFernBlockEntity>> GIANT_FERN = register("giant_fern", () -> BlockEntityType.Builder.of(GiantFernBlockEntity::new).build(null));
