    ...
    protected void registerRecipes() {
        ...
        ModBlocks.HELPER.getRegistryObjects().forEach(registryObject -> {
            if (registryObject.get() instanceof PostBlock postBlock) {
                this.add(new AxeCraftingRecipeBuilder(RecipeCategory.BUILDING_BLOCKS, Ingredient.of(postBlock.getLogBlock()), postBlock.asItem(), 2).unlockedBy("has_item", has(postBlock.getLogBlock())));
                ...
                if (postBlock != null) {
                    this.add(new AxeCraftingRecipeBuilder(RecipeCategory.BUILDING_BLOCKS, Ingredient.of(postBlock), registryObject.get().asItem(), 4).unlockedBy("has_item", has(postBlock)));
                }
            }
        });
        ...
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_OAK_POSTS.get(), RecipePart.of(ModBlocks.OAK_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_SPRUCE_POSTS.get(), RecipePart.of(ModBlocks.SPRUCE_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_BIRCH_POSTS.get(), RecipePart.of(ModBlocks.BIRCH_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_JUNGLE_POSTS.get(), RecipePart.of(ModBlocks.JUNGLE_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_ACACIA_POSTS.get(), RecipePart.of(ModBlocks.ACACIA_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_DARK_OAK_POSTS.get(), RecipePart.of(ModBlocks.DARK_OAK_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_CRIMSON_POSTS.get(), RecipePart.of(ModBlocks.CRIMSON_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_WARPED_POSTS.get(), RecipePart.of(ModBlocks.WARPED_POST.get()));

        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_STRIPPED_OAK_POSTS.get(), RecipePart.of(ModBlocks.STRIPPED_OAK_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_STRIPPED_SPRUCE_POSTS.get(), RecipePart.of(ModBlocks.STRIPPED_SPRUCE_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_STRIPPED_BIRCH_POSTS.get(), RecipePart.of(ModBlocks.STRIPPED_BIRCH_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_STRIPPED_JUNGLE_POSTS.get(), RecipePart.of(ModBlocks.STRIPPED_JUNGLE_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_STRIPPED_ACACIA_POSTS.get(), RecipePart.of(ModBlocks.STRIPPED_ACACIA_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_STRIPPED_DARK_OAK_POSTS.get(), RecipePart.of(ModBlocks.STRIPPED_DARK_OAK_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_STRIPPED_CRIMSON_POSTS.get(), RecipePart.of(ModBlocks.STRIPPED_CRIMSON_POST.get()));
        this.simple2x2(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BUNDLED_STRIPPED_WARPED_POSTS.get(), RecipePart.of(ModBlocks.STRIPPED_WARPED_POST.get()));
