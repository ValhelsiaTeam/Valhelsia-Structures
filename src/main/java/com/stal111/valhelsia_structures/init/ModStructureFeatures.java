...
public class ModStructureFeatures {
    ...
    public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> DESERT_HOUSE = register("desert_house", ModStructures.DESERT_HOUSE.get().withConfiguration(new VillageConfig(() -> SimpleStructurePools.DESERT_HOUSE_PATTERN, 7)));
    ...
    public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> PLAYER_HOUSE = register("player_house", ModStructures.PLAYER_HOUSE.get().withConfiguration(new VillageConfig(() -> SimpleStructurePools.PLAYER_HOUSE_PATTERN, 7)));
