...
public class SpawnerDungeonPools extends DatapackRegistryClass<StructureTemplatePool> {
    ...
    public void bootstrap(BootstrapContext<StructureTemplatePool> context) {
        START.create(HELPER, context, "spawner_dungeon/cave_entrance", builder -> builder.element("large").element("small_1").element("small_2").element("small_3"), TerrainAdjustment.BEARD_THIN);
