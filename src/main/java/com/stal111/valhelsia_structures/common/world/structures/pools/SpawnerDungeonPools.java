...
public class SpawnerDungeonPools {
    ...
    public static final Holder<StructureTemplatePool> PATTERN = JigsawHelper.register("spawner_dungeon/entrances", StructureTemplatePool.Projection.RIGID, ImmutableList.of(Pair.of("spawner_dungeon/entrance", 1)), true);
