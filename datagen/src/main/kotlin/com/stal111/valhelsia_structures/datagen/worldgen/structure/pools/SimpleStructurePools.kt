...
object SimpleStructurePools : RegistryDataProvider<StructureTemplatePool> {
    ...
    override fun bootstrap(context: BootstrapContext<StructureTemplatePool>) {
        ...
        BuiltInStructurePools.CASTLES.create(HELPER, context) { it.element("castle") }
        BuiltInStructurePools.CASTLE_RUINS.create(HELPER, context, "ruins") { it.element("castle_ruin") }
        BuiltInStructurePools.FORGES.create(HELPER, context, "forge") { it.element("forge_1").element("forge_2") }
        BuiltInStructurePools.TOWER_RUINS.create(HELPER, context, "ruins") {
            it.element("tower_ruin_1").element("tower_ruin_2").element("tower_ruin_3")
        }
        BuiltInStructurePools.SPAWNER_ROOMS.create(HELPER, context, "spawner_room") {
            it.element("spawner_room_1").element("spawner_room_2").processors(BuiltInProcessorLists.SPAWNER_ROOM)
        }
        BuiltInStructurePools.DEEP_SPAWNER_ROOMS.create(HELPER, context, "deep_spawner_room") {
            it.element("deep_spawner_room_1").processors(BuiltInProcessorLists.DEEP_SPAWNER_ROOM)
        }
        BuiltInStructurePools.WITCH_HUTS.create(HELPER, context, "witch_hut") {
