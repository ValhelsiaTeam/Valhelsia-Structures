...
class ModItemTagsProvider(context: DataProviderContext.Server) : DataForgeItemTagsProvider(context) {
    override fun addTags(provider: HolderLookup.Provider) {
        ...
        copy(ModTags.Blocks.NON_FLAMMABLE_POSTS, ModTags.Items.NON_FLAMMABLE_POSTS)
        ...
        copy(ModTags.Blocks.COLORED_JARS, ModTags.Items.COLORED_JARS)
        copy(ModTags.Blocks.JARS, ModTags.Items.JARS)
        copy(ModTags.Blocks.SLEEPING_BAGS, ModTags.Items.SLEEPING_BAGS)
